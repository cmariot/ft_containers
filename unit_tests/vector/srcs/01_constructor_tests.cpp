...
/*   Updated: 2022/08/18 20:15:18 by cmariot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		int 	value	= 42;
//
//		ft::ft::vector<int>			ft_fill(n, value);
//		std::ft::vector<int>		std_fill(n, value);
//
...
//		// Copy constructor
//		{
//			ft::ft::vector<int>		ft_copy(ft_fill);
//			std::ft::vector<int>	std_copy(std_fill);
//
...
//		// Range constructor
//		{
//			ft::ft::vector<int>		ft_range(ft_fill.begin(), ft_fill.end());
//			std::ft::vector<int>	std_range(std_fill.begin(), std_fill.end());
//
